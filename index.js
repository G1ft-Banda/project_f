                                              ...
                                              for (let i = 0; i < articles.length; i++) {
                                                    const article = articles[i];
                                                          ...
                                                          // Extract the headline text
                                                                const headline = $(article).find("a.news-list__headline-link").text().trim();
                                                                      
                                                                            // Extract the article content
                                                                                  const content = $(article).find("p.news-list__snippet").text().trim();

                                                                                        // Add the headline and content to the array
                                                                                              contentArray.push(`Date: ${new Date().toDateString()}\n\nURL: ${url}\n\n${headline}\n\n${content}\n\n`);
                                                                                                                                                                                            ...
                                                                                                                                                                                            // Send the list of text files to the client
                                                                                                                                                                                              res.send(`
                                                                                                                                                                                                  <h1>List of articles:</h1>
                                                                                                                                                                                                      ${fileList.map(file => `<p><a href="/${dirName}/${file.file}" download>${file.date} - ${file.file}</a></p>`).join("\n")}
                                                                                                                                                                                                        `);
                                                                                                                                                                                                        });
